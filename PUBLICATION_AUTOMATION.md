...
Google Scholar does not provide an official public API, so this workflow uses SerpAPI as a safer structured source. The pull request should still be reviewed before merging because citation metadata may need small manual corrections.
